...
// ★ 출결·과제·프로젝트 퀄리티·태도·팀워크 등 "강사가 직접 판단하는 펀더멘탈"은 이 랜덤 풀에서 뺐다.
//   → 별도 레버 📣강사 이벤트(events.js / postInstructorEvent)가 담당(강사가 성실 팀에 랜덤 악재를
//   씌우는 충돌 방지). 자동 엔진은 시장·사업·분위기 뉴스만 무작위로 낸다.
export const TPL = {
  individual: {
    good: ['{기업}, 신작 대박 조짐에 매수세 몰려', '{기업} 깜짝 흑자 전환', '{기업} 대형 계약 수주', '{기업} 신규 팬덤 형성', '{기업} 입소문 타고 신규 유입'],
    bad: ['{기업} 서버 대란에 이용자 이탈', '{기업} 자금난설에 투자 경고', '{기업} 평판 악화로 매도 행렬', '{기업} 어닝 쇼크', '{기업} 경쟁사에 밀려 점유율 하락', '{기업} 차익실현 매물 출회', '{기업} 투자 유치 불발설', '{기업} 목표주가 하향 조정'],
