...
for (const e of led) {
  switch (e.type) {
    ...
    case 'user_delete':   bump('user_delete', (e.houseDelta || 0)); break; // 퇴소 계정 삭제 — 잔고 전액 회수(하우스 충전)
...
const order = ['mint', 'burn', 'delist', 'operator_clawback', 'trade_fee', 'dp_convert', 'news(auto)', 'dividend', 'weekly_dividend', 'help_grant', 'quiz_reward', 'admin_grant', 'user_delete', 'holdem_shortfall', 'option_grant', 'price_adjust'];
